...
export class HubServer {
    private ownAgent: { callTool(name: string, args: Record<string, unknown>): Promise<ToolResult> };
    ...
    constructor(
        ownAgent: { callTool(name: string, args: Record<string, unknown>): Promise<ToolResult> },
        ownSessionId: string,
